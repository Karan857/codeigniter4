        ...
        <?php if (session()->get('logged_in')) : ?>
            <div class="hidden md:flex space-x-4">
                <?php if (session()->get('role') == 'admin') : ?>
                    <a href="<?= base_url(); ?>product" class="text-white hover:text-yellow-200 transition text-xl">จัดการสินค้า</a>
                    <a href="<?= base_url(); ?>user-list" class="text-white hover:text-yellow-200 transition text-xl">รายชื่อ</a>
                <?php else : ?>
                    <a href="<?= base_url(); ?>home" class="text-white hover:text-yellow-200 transition text-xl">หน้าแรก</a>
                    <a href="<?= base_url(); ?>list" class="text-white hover:text-yellow-200 transition text-xl">รถยนต์</a>
                <?php endif; ?>
            </div>
            ...
            <div class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                    <div class="px-4 py-3">
                        ...
                        <span class="block text-sm text-gray-500 truncate dark:text-gray-400"><?= $loggedUser['email']; ?></span>
                    </div>
