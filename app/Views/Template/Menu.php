    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex space-x-4">
            ...
            <a href="<?= base_url(); ?>product"
                class="text-white hover:text-yellow-200 transition text-xl">จัดการสินค้า</a>
            <a href="<?= base_url(); ?>user-list"
                class="text-white hover:text-yellow-200 transition text-xl">รายชื่อ</a>
            <?php else : ?>
            <a href="<?= base_url(); ?>home" class="text-white hover:text-yellow-200 transition text-xl">หน้าแรก</a>
            <a href="<?= base_url(); ?>product" class="text-white hover:text-yellow-200 transition text-xl">สินค้า</a>
            <?php endif; ?>
        </div>
