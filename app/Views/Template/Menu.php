        ...
        <?php if (session()->get('logged_in')) : ?>
            <div class="hidden md:flex space-x-4">
                <?php if (session()->get('role') == 'admin') : ?>
                    ...
                    <a href="<?= base_url('product'); ?>" class="text-white hover:text-yellow-200 transition text-xl <?= (current_url() == base_url('/index.php/product')) ? 'text-yellow-200 font-bold' : ''; ?>">จัดการสินค้า</a>
