<div class="bg-gray-900 h-screen flex flex-col justify-center items-center relative">
        ...
        ?>
                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <?php if ($product['image'] != '' && file_exists($product['image'])) : ?>
                        <img class="p-8 rounded-t-lg w-full h-[200px] bg-cover border-gray-200 shadow-sm shadow-gray-500/50 shadow-bottom mb-5" src="<?= $product['image']; ?>" alt="image" />
                    <?php endif ?>
