<div class="mt-2 text-center  rounded-lg mx-[50px] ">
    <div class="flex mx-[50px]">
        <div id="default-carousel" class="relative w-2/4 mb-[100px]" data-carousel="slide">
        ...
        <div id="product-details" class="text-start w-2/4 px-[50px] py-[30px] relative bg-gray-100 rounded-lg shadow-md max-w-2xl mx-auto h-[500px]">
            <h2 class="text-3xl font-bold mb-6 text-blue-600">Our Cars</h2>

            <div class="mb-8">
                <h3 class="text-2xl font-semibold mb-3 text-gray-800">New Cars</h3>
                <p class="text-gray-600 leading-relaxed">
                    Experience superior driving with our latest car models. Featuring advanced technology,
                    sleek design, and exceptional performance, you will feel luxury and safety in every journey.
                </p>
            </div>

            <div class="mb-8">
                <h3 class="text-2xl font-semibold mb-3 text-gray-800">Used Cars</h3>
                <p class="text-gray-600 leading-relaxed">
                    We offer high-quality used cars, thoroughly inspected and with clear maintenance history.
                    With reasonable prices, you can easily own your dream car with confidence in every purchase.
                </p>
            </div>

            <div class="text-center mt-6">
                <a href="<?= base_url(); ?>product" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out transform hover:scale-105">
                    View All Cars
                </a>
            </div>
        </div>
...
<div class="flex justify-around mx-[10px] mb-[50px]">
    ...
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <ul role="list" class="space-y-5 my-7">
            <li class="flex items-center">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">2 Free car
                    washes</span>
            </li>
            <li class="flex">
                <svg class="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Free drinking
                    and coffee </span>
            </li>
            ...
            <li class="flex line-through decoration-gray-500">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">1 Free oil change</span>
            </li>
            <li class="flex line-through decoration-gray-500">
                <svg class="flex-shrink-0 w-4 h-4 text-gray-400 dark:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                </svg>
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">3rd class insurance </span>
            </li>
            <li class="flex line-through decoration-gray-500">
                <svg class="flex-shrink-0 w-4 h-4 text-gray-400 dark:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                </svg>
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">5 % discount</span>
            </li>
            <li class="flex line-through decoration-gray-500">
                <svg class="flex-shrink-0 w-4 h-4 text-gray-400 dark:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                </svg>
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">24-hour service</span>
            </li>
        </ul>
        <button id="me" onClick="me()" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choose
            plan</button>
    </div>
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <button onClick="me()" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choose
            plan</button>
    </div>
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex items-baseline text-gray-900 dark:text-white">
            <span class="text-3xl font-semibold">$</span>
            <span class="text-5xl font-extrabold tracking-tight">109</span>
            <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
        </div>
        <ul role="list" class="space-y-5 my-7">
            <li class="flex items-center">
...
<hr class="m-[100px] w-3/4">
<div class="flex justify-around mx-[10px]">
    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-center w-[400px]">
        <a href="#">
            <i class="fal fa-car-tilt text-center text-6xl item-center mb-8"></i>
            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white text-center">
                Need a Fast Car?
            </h5>
        </a>
        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400 text-start">
            You're in the right place. Come visit our shop for the best high-performance cars. Vroom vroom!
        </p>
    </div>
    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-center w-[400px]">
        <a href="#">
            <i class="fal fa-car-mechanic text-center text-6xl item-center mb-8"></i>
            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white text-center">
                Want to Customize Your Ride?
            </h5>
        </a>
        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400 text-start">
            N Whether it's a new paint job or engine upgrades, we've got you covered. Bring your car to our expert
            mechanics!
        </p>
    </div>
    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-center w-[400px]">
        <a href="#">
            <i class="far fa-check-circle text-center text-6xl item-center mb-8"></i>
            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white text-center">
                Looking for Reliable Car Maintenance?
            </h5>
        </a>
        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400 text-start">
            Our experienced technicians provide top-notch maintenance services. Keep your car in perfect condition.
            Visit us today!
        </p>
    </div>
</div>
...
<div class="w-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-[50px]">
    <div class="sm:hidden">
        ...
        <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="stats" role="tabpanel" aria-labelledby="stats-tab">
            <dl class="grid max-w-screen-xl grid-cols-2 gap-8 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white sm:p-8">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <dd class="text-gray-500 dark:text-gray-400">Experience</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold">100M+</dt>
                    <dd class="text-gray-500 dark:text-gray-400">follower</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold">1000s</dt>
                    <dd class="text-gray-500 dark:text-gray-400">History</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold">1B+</dt>
                    <dd class="text-gray-500 dark:text-gray-400">Subscribe</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        ...
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Codeigniter</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Composer</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="https://github.com/Karan857/myshop" class="hover:underline ">Github</a>
                        </li>
                        <li>
                            <a href="#">Discord</a>
                        </li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Car & Bomb™</a>. All Rights Reserved.
            </span>
