    ...
    <div class="flex mx-[50px]">
        ...
        <div id="product-details" class="text-start w-2/4 px-[50px] py-[30px] relative bg-gray-100 rounded-lg shadow-md max-w-2xl mx-auto h-[500px]">
            ...
            <div class="text-center mt-6">
                <a href="<?= base_url(); ?>list" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out transform hover:scale-105">
                    View All Cars
                </a>
            </div>
        </div>
